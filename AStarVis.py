...
class Visualizer:
    ...
    def changeColor(self, pos, newColor):
        self.board[pos[1]][pos[0]].setColor(newColor)

# def makeBoard(rows, nodeWidth):
#     retBoard = []
#     for i in range(rows):
#         rowList = []
#         for j in range(rows):
#             newNode = Node((i,j), white, nodeWidth)
#             rowList.append(newNode)
#
#         retBoard.append(rowList)
#
#     return retBoard
#
# def getNode(pos, board):
#     return board[pos[0]][pos[1]]
#
# def drawBoard(window, rows, nodeWidth):
#     for i in range(rows):
#         y = i * nodeWidth
#         pygame.draw.line(window, black, (0, y), (size, y))
#
...
#         pygame.draw.line(window, black, (x, 0), (x, size))
#
# def draw(window, board, rows, nodeWidth):
#     for row in board:
#         for n in row:
#             n.drawRect(window)
#
#     drawBoard(window, rows, nodeWidth)
#     pygame.display.update()
#
# def clickPos(pos, nodeWidth):
#     row = pos[0] // nodeWidth
#     col = pos[1] // nodeWidth
#
#     return (row, col)
